...
public class SessionControllerUnitTest {
        ...
        public void testSessionFindById() {
                ...
                assertEquals(session.getId(), sessionDtoBody.getId() != null ? sessionDtoBody.getId() : null);
                System.out.println("RESULTAT DU TEST : " + session.getId().toString() + " / "
                                + sessionDtoBody.getId().toString());
                assertEquals(session.getName(), sessionDtoBody.getName() != null ? sessionDtoBody.getName() : null);
                System.out.println("RESULTAT DU TEST : " + session.getName().toString() + " / "
                                + sessionDtoBody.getName().toString());
        }
