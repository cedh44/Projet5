...
public class TeacherControllerUnitTest {
    ...
    public void testTeacherFindByIdFound() {
        ...
        TeacherDto teacherDto = new TeacherDto(id, "DELAHAYE", "Margot", LocalDateTime.parse("2023-08-29T00:00:00"),
                LocalDateTime.parse("2023-08-29T00:00:00"));
    ...
    public void testTeacherFindAll() {
        ...
        teachersList.add(new Teacher((long) 1, "DELAHAYE", "Margot", LocalDateTime.parse("2023-08-29T00:00:00"),
                LocalDateTime.parse("2023-08-29T00:00:00")));
        teachersList.add(new Teacher((long) 2, "THIERCELIN", "Hélène", LocalDateTime.parse("2023-08-29T00:00:00"),
                LocalDateTime.parse("2023-08-29T00:00:00")));
        List<TeacherDto> dtoTeachersList = new ArrayList<>();
        dtoTeachersList.add(new TeacherDto((long) 1, "DELAHAYE", "Margot", LocalDateTime.parse("2023-08-29T00:00:00"),
                LocalDateTime.parse("2023-08-29T00:00:00")));
        dtoTeachersList.add(new TeacherDto((long) 2, "THIERCELIN", "Hélène", LocalDateTime.parse("2023-08-29T00:00:00"),
                LocalDateTime.parse("2023-08-29T00:00:00")));
        ...
        assertEquals(teachersList.get(0).getId(), dtoTeachersListBody != null ? dtoTeachersListBody.get(0).getId() : null);
        assertEquals(teachersList.get(1).getId(), dtoTeachersListBody != null ? dtoTeachersListBody.get(1).getId() : null);
